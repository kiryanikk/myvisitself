...
(() => {
  ...
  const i18n = {
    ru: {
      ...
      "hero.hi": "Привет, я",
      "hero.name": "Никита",
      "hero.sub": "Мне 16. Делаю Telegram‑ботов, автоматизацию на Python, небольшие сайты и иногда пишу игровые системы для MTA.",
      ...
      "sections.info.about.desc": "16 год. Люблю чистый UX, быстрые сайты и автоматизацию, которая экономит время.",
    ...
    en: {
      ...
      "hero.hi": "Hi, I'm",
      "hero.name": "Nikita",
      "hero.sub": "I'm 16. I build Telegram bots, automate stuff with Python, make small websites, and sometimes ship game systems for MTA.",
      ...
      "sections.info.about.desc": "16 y.o. Developer. I like clean UX, fast sites, and automation that saves time.",
